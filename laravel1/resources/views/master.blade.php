    ...
    <nav class="navbar navbar-expand-md bg-warning">
        ...
        <div class="container">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li> <a href="{{ route('about') }}" class="nav-link text-dark fw-bold"> About</a> </li>
                <li> <a href="{{ route('contact') }}" class="nav-link text-dark fw-bold"> Contact</a> </li>
                <li> <a href="{{ route('login') }}" class="nav-link text-dark fw-bold"> Login</a> </li>
            </ul>
        </div>
